        ...
        <div class="col-md-6 bg-light full-height-register center-text">
            <div class='d-flex flex-column flex-md-row'>
              <div>
                ...
                <div class="col-md-12 mb-2 center-text">
                    <a href="{{ route('generar.factura.novalidado.open', ['idCarrera' => $datos['idCarrera'], 'CIFaseguradora' => $datos['CIFaseguradora']]) }}" class="d-block btn btn-primary">Descargar factura</a>
                </div>
                <div class="col-md-12 mb-2 center-text"> 
